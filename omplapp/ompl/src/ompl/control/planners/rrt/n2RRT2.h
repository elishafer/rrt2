...
#ifndef OMPL_CONTROL_PLANNERS_RRT_n2RRT2_
#define OMPL_CONTROL_PLANNERS_RRT_n2RRT2_
...
namespace ompl
{
    ...
    {
        /**
         * Another version of Nested RRT2.0 which shares the tree that is created in the reduced state space problem while 
         * computing c_max with the full problem computation. Thus, it operates in a more integrated fashion.
        */

        class n2RRT2 : public base::Planner
        {
        public:
            /** \brief Constructor */
            n2RRT2(const SpaceInformationPtr &si);

            ~n2RRT2() override;

            /** \brief Solves the problem for some specified time. Return true if solution was found. */
            base::PlannerStatus solve(const base::PlannerTerminationCondition &ptc) override;

            /** \brief Clear the datastructures */
            void clear() override;

            /** Set the goal bias, how often the goal is sampled. */
